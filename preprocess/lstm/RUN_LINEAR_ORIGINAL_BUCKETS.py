...
INSTANCE = LSTM_Loader('LINEAR_buckets')

INSTANCE = LSTM_Loader('LINEAR_buckets_Adam', 'Adam')
INSTANCE = LSTM_Loader('LINEAR_buckets_adadelta', 'Adadelta')
INSTANCE = LSTM_Loader('LINEAR_buckets_sgd', 'sgd')
